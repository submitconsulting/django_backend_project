...
class TypeCannotBeNullException(Exception):
	def __init__(self):
		self.parameter = _("Type cannot be null.")
	def __str__(self):
		return self.parameter

class TypeIdentifierCannotBeNullOrEmptyException(Exception):
	def __init__(self):
		self.parameter = _("Type identifier cannot be null.")
	def __str__(self):
		return self.parameter

class TypeNotFoundException(Exception):
	def __init__(self):
		self.parameter = _("Type not found in the database.")
	def __str__(self):
		return self.parameter

class TypeCodeAlreadyInUseException (Exception):
	def __init__(self, code):
		self.parameter = _("Type %(code)s code's already in use.") % {'code':code}
	def __str__(self):
		return self.parameter

class TypeNameAlreadyInUseException (Exception):
	def __init__(self, name):
		self.parameter = _("Type %(name)s name's already in use.") % {'name':name}
	def __str__(self):
		return self.parameter

class TypeCouldNotBeDeletedException(Exception):
	def __init__(self, name):
		self.parameter = _("Type %(name)s could not be deleted because it has associated records.") % {'name':name}
	def __str__(self):
		return self.parameter

class TypeOtherException(Exception):
	def __init__(self):
		self.parameter = _("Type other exception.")
	def __str__(self):
		return self.parameter