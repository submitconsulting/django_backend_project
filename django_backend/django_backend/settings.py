...
########## APP_AJAX
#os.environ['APP_AJAX'] = 'mysite.settings'
APP_AJAX = True
#os.environ.setdefault("APP_AJAX", "eee") 
########## END APP_AJAX
...
INSTALLED_APPS = (
    ...
    #apps para el módulo de Backend Manager para apps Django
    'apps.helpers',
    'apps.params',
    'apps.space',
    'apps.sad',
