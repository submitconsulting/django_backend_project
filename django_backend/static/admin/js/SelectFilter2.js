...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_static_prefix) {
        ...
        var title_available = quickElement('h5', selector_available, interpolate(gettext('Available %s') + ' ', [field_name]));
        ...
        var title_chosen = quickElement('h5', selector_chosen, interpolate(gettext('Chosen %s') + ' ', [field_name]));
